...
print("num of images:", len(image_data))

os.makedirs('img_masks', exist_ok=True)
    ...
    try:
        ...
        if len(detections) == 0:
            ...
            if mask is not None:
                ...
                mask_image.save(f'images_masks/{label}.png')
                print(f"{label} mask generated!")
            else:
                print(f"No mask generated for {label}.")
