...
parser.add_argument('--no_rembg', action='store_true', help='Do not remove input background.')  # default: False
...
for idx, image_file in enumerate(input_files):
    ...
    if not args.no_rembg:
        input_image = remove_background(input_image, rembg_session, True)
